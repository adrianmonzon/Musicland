...
router.post('/signup', (req, res) => {
    ...
    const { username, password, name, description, instrument, age, email } = req.body   //falta imagen
    ...
    User
        .create({ username, password: hashPass, name, description, instrument, age, email })
