...
router.post('/signup', (req, res) => {
    ...
    const { username, password, name, description, instrument, age, email, image } = req.body   
    ...
    User
        .create({ username, password: hashPass, name, description, instrument, age, email, image })
